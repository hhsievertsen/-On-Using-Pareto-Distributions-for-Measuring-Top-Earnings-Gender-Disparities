...
*ranking
sort year v_female v_educ_group v_income1
...
by year v_female v_educ_group: cumul v_log_income1, gen(cdf_log_income)
...
mle_pareto,bys(v_educ_group) income(v_log_income1) pareto_cutoff(0.1) savecoef("$of\coefficients_education.dta")
	

			
use "$of\coefficients_education.dta",clear	
...
graph export "$of\ceiling_education.png",replace width(2000)
...
graph export "$of\gap_education_ln.png",replace width(2000)
